...
type FindingRiskContext struct {
	...
	CachedKEV       bool
	HasExploit      bool
	InternetExposed bool   // true si el endpoint tiene IP pública o está en una subred expuesta a Internet
	Environment     string // entorno del endpoint (producción, desarrollo, etc.)
