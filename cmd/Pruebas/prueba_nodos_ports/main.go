...
func main() {
	...
	endpointRepo, vulnRepo, softwareRepo, softwareInstRepo, findingRepo, remediationRepo, exploitRepo, hardwareRepo, networkRepo, patchRepo, projectRepo, dbHelper, _ , _ := neo4j.NewRepository(driver)
	_ = dbHelper
	_ = softwareInstRepo
